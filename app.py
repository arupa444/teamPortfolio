...
TEAM_DATA = {
    "arupa-swain": {
        ...
        "bio": "AI/ML Engineer specializing in LLMs, agentic systems, and deep learning, with hands-on experience building end-to-end AI solutions and full-stack applications. Demonstrated research impact in sparse matrix optimization, achieving significant memory reduction and performance gains. Proficient in Go, Python, JavaScript, C/C++, and modern ML frameworks including TensorFlow and PyTorch.",
        ...
        "skills": ["Go", "FastAPI", "LangGraph", "Multi-Agent Systems", "System Design", "LangChain"],
        "experience": [
        ...
        "projects": [
            ...
            {"title": "Author Contact Extraction", "tech": "FastAPI / SMTP",
             "desc": "Toolkit scraping contacts from sites with 3-phase validation (DNS/MX) for 10,000+ contacts and automate the bulk mailing."},
    ...
    "ashutosh-mishra": {
        ...
        "bio": "AI/ML Engineer focused on Large Language Models, multi-agent systems, and deep learning. Experienced in delivering production-grade AI solutions such as automated journal generation, sentiment analysis, OCR workflows, and custom neural networks. Strong grounding in ML theory, optimization, and scalable deployment using TensorFlow, FastAPI, and Hugging Face for real-world impact.",
        ...
        "skills": ["Agentic AI", "LLMs", "TensorFlow", "RAG", "Prompt Engineering", "NLP"],
        "experience": [
    ...
    "bavisetti-daniel": {
        ...
        "bio": "Machine Learning Engineer with strong expertise in Python, TensorFlow, and PyTorch, focused on high-throughput ML pipelines and real-time computer vision and NLP systems. Experienced in large-scale data processing and optimizing edge-based inference on IoT devices, delivering measurable improvements in model accuracy, speed, and overall efficiency.",
